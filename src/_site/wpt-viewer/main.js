import { get_result } from '../../wpt/get_result.js';
import { get_image_src } from '../../wpt/get_image.js';
import { chart, legend } from './sankey.js';
import { get_web_vitals_score, is_metric } from '../../bigquery_score/score.js';

const resultEl = document.querySelector('wpt-viewer');
...
if (resultEl) {
	...
	if (test) {
		...
		resultEl?.appendChild(configBlock);
		resultEl?.appendChild(pageBlock);
		...
		resultEl.appendChild(overviewBlock);
...
/** @typedef {import('../../wpt/get_result.parser.js').Request[]} Requests */

/** @type {(type: import('../../wpt/get_result.parser.js').Request["request_type"]) => "Script" | "Document" | "Font" | "Media" | "Other"} */
